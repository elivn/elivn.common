...
using Elivn.AliyunOssSdk.Api;
using Elivn.AliyunOssSdk.Api.Bucket.Get;
using Elivn.AliyunOssSdk.Api.Bucket.List;
using Elivn.AliyunOssSdk.Api.Object.Append;
using Elivn.AliyunOssSdk.Api.Object.Copy;
using Elivn.AliyunOssSdk.Api.Object.Delete;
using Elivn.AliyunOssSdk.Api.Object.DeleteMultiple;
using Elivn.AliyunOssSdk.Api.Object.Get;
using Elivn.AliyunOssSdk.Api.Object.GetMeta;
using Elivn.AliyunOssSdk.Api.Object.Head;
using Elivn.AliyunOssSdk.Api.Object.Put;
using Elivn.AliyunOssSdk.Entites;
using Elivn.AliyunOssSdk.Request;
using Elivn.AliyunOssSdk.Utility;
using Elivn.AliyunOssSdk.Utility.Authentication;
using Microsoft.Extensions.Logging;

namespace Elivn.AliyunOssSdk
{
    /// <summary>
    /// 封装并简化调用接口
    /// </summary>
