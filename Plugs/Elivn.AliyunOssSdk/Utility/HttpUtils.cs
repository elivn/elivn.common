...
namespace Elivn.AliyunOssSdk.Utility
{
    internal static class HttpUtils
    {
        ...
        //    var mimeLines = MimeData.Data.Split(new string[] {"\n"}, StringSplitOptions.RemoveEmptyEntries);
        ...
        public static string CombineQueryString(IEnumerable<KeyValuePair<string, string>> parameters)
        {
            var isFirst = true;
